...
export default function ProposalView({ onNext }: ProposalProps) {
    return (
            ...
            <div className="relative z-10 px-4 md:px-0 w-full md:w-full max-w-lg md:max-w-3xl mx-auto flex flex-col gap-6">
                ...
                <div className="relative bg-[#1E1E1E] border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col items-center justify-center text-center gap-8 min-h-[400px]">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight md:leading-snug drop-shadow-lg" style={{ fontFamily: '"Playfair Display", serif' }}>
                        Before we continue, you must <br/> answer this test!
                    </h2>
                    ...
                    <div className="relative mt-4">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="bg-[#C08081] text-white text-xl md:text-2xl font-bold py-6 px-10 md:px-12 rounded-2xl shadow-[0_10px_30px_rgba(192,128,129,0.4)] uppercase tracking-widest border border-white/10 hover:bg-[#d48a8b] hover:shadow-[0_15px_40px_rgba(192,128,129,0.6)] transition-all duration-300"
